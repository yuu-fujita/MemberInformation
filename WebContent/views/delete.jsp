...
<body>
	...
	<form method="post" action="UpdateServlet">
		...
		<!-- 会員番号の検索 -->
		<label for="member_id">会員番号の検索</label>
		...
		<input type="text" id="first_name" name="first_name" value="${firstName}"required><br><br>
		...
		<input type="text" id="phone_number" name="phone_number" value="${phoneNumber}"required><br><br>

		<!-- メールアドレスの入力 -->
		<label for="mail_address">■メールアドレス<br></label>
		<input type="email" id="mail_address" name="mail_address" value="${mailAddress}" required><br><br>
